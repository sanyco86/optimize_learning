...
![Massif Visualizer](files/before.png)
...
Интересно, но это дало неплохой результат и метрика выросла с `10.744ips` до `14.509ips`
...
![Massif Visualizer](files/after.png)
